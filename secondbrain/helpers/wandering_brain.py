...
@st.cache_resource
def load_Llama_cpp_model(model_name, model_path, max_token, temp, top_p, top_k):
    local_path = '{}/{}'.format(model_path, model_name)  # replace with your desired local file path
...
class WanderingBrain:
    ...
    def run_Llama_cpp(self, model_name, prompt, model_path, max_token, temp, top_p, top_k):
